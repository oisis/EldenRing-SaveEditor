...
func validateWeaponData(data WeaponData, sources map[SourceID]struct{}, extended bool) error {
	...
	optional := []struct {
		...
		{"item.weapon.statusPoison", optionalFactValidator(data.StatusPoison)},
		{"item.weapon.statusBleed", optionalFactValidator(data.StatusBleed)},
		{"item.weapon.statusFrost", optionalFactValidator(data.StatusFrost)},
		{"item.weapon.statusSleep", optionalFactValidator(data.StatusSleep)},
		{"item.weapon.statusMadness", optionalFactValidator(data.StatusMadness)},
		{"item.weapon.statusScarletRot", optionalFactValidator(data.StatusScarletRot)},
