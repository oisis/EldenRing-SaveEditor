...
func copyWeaponStats(value data.WeaponStatsV1) *weaponStatsSeed {
	...
	return &weaponStatsSeed{
		...
		StatusPoison: value.StatusPoison, StatusBleed: value.StatusBleed,
		StatusFrost: value.StatusFrost, StatusSleep: value.StatusSleep,
		StatusMadness: value.StatusMadness, StatusScarletRot: value.StatusScarletRot,
