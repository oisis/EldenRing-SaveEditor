...
var Information = map[uint32]ItemData{
	...
	0x4000222E: {Name: "Note: Hidden Cave", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_hidden_cave.png"},
	0x4000222F: {Name: "Note: Imp Shades", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_imp_shades.png"},
	0x40002230: {Name: "Note: Flask of Wondrous Physick", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_flask_of_wondrous_physick.png"},
	0x40002231: {Name: "Note: Stonedigger Trolls", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_stonedigger_trolls.png"},
	0x40002232: {Name: "Note: Walking Mausoleum", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_walking_mausoleum.png"},
	0x40002233: {Name: "Note: Unseen Assassins", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_unseen_assassins.png"},
	0x40002234: {Name: "Note: Great Coffins", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_great_coffins.png"},
	0x40002235: {Name: "Note: Flame Chariots", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_flame_chariots.png"},
	0x40002236: {Name: "Note: Demi-human Mobs", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_demi_human_mobs.png"},
	0x40002237: {Name: "Note: Land Squirts", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_land_squirts.png"},
	0x40002238: {Name: "Note: Gravity's Advantage", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_gravitys_advantage.png"},
	0x40002239: {Name: "Note: Revenants", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_revenants.png"},
	0x4000223A: {Name: "Note: Waypoint Ruins", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_waypoint_ruins.png"},
	0x4000223B: {Name: "Note: Gateway", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_gateway.png"},
	0x4000223D: {Name: "Note: Frenzied Flame Village", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_frenzied_flame_village.png"},
