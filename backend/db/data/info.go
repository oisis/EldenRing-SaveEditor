...
var Information = map[uint32]ItemData{
	...
	// ─── Notes (base) ───────────────────────────────────────────────────
	0x4000083F: {Name: "Note: Miquella's Needle", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_miquellas_needle.png"},
	0x40000838: {Name: "Note: The Lord of Frenzied Flame", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_the_lord_of_frenzied_flame.png"},
	0x4000083C: {Name: "Note: Hidden Cave", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_hidden_cave.png"},
	0x4000083D: {Name: "Note: Imp Shades", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_imp_shades.png"},
	0x40000836: {Name: "Note: Flask of Wondrous Physick", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_flask_of_wondrous_physick.png"},
	0x40000842: {Name: "Note: Stonedigger Trolls", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_stonedigger_trolls.png"},
	0x40000844: {Name: "Note: Walking Mausoleum", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_walking_mausoleum.png"},
	0x40000843: {Name: "Note: Unseen Assassins", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_unseen_assassins.png"},
	0x4000083B: {Name: "Note: Great Coffins", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_great_coffins.png"},
	0x40000835: {Name: "Note: Flame Chariots", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_flame_chariots.png"},
	0x40000834: {Name: "Note: Demi-human Mobs", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_demi_human_mobs.png"},
	0x40000846: {Name: "Note: Land Squirts", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_land_squirts.png"},
	0x4000083A: {Name: "Note: Gravity's Advantage", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_gravitys_advantage.png"},
	0x40000840: {Name: "Note: Revenants", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_revenants.png"},
	0x40000845: {Name: "Note: Waypoint Ruins", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_waypoint_ruins.png"},
	0x40000847: {Name: "Note: Gateway", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_gateway.png"},
	0x40000837: {Name: "Note: Frenzied Flame Village", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_frenzied_flame_village.png"},
	...
	0x40000841: {Name: "Note: Sealed Spiritsprings", Category: "info", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/tools/note_sealed_spiritsprings.png", Flags: []string{"dlc"}},
}
