...
var Information = map[uint32]ItemData{
	...
	0x401EA488: {Name: "Incursion Painting", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/incursion_painting.png", Flags: []string{"dlc", "stackable"}},
	0x401EA489: {Name: "The Sacred Tower Painting", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/the_sacred_tower_painting.png", Flags: []string{"dlc", "stackable"}},
	0x401EA48A: {Name: "Domain of Dragons Painting", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/domain_of_dragons_painting.png", Flags: []string{"dlc", "stackable"}},
	...
	// ─── Notes (base) ───────────────────────────────────────────────────
	0x4000220A: {Name: "Note: Miquella's Needle", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_miquellas_needle.png", Flags: []string{"stackable"}},
	0x4000220C: {Name: "Note: The Lord of Frenzied Flame", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_the_lord_of_frenzied_flame.png", Flags: []string{"stackable"}},
	0x4000222E: {Name: "Note: Hidden Cave", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_hidden_cave.png", Flags: []string{"stackable"}},
	0x4000222F: {Name: "Note: Imp Shades", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_imp_shades.png", Flags: []string{"stackable"}},
	...
	0x40002232: {Name: "Note: Walking Mausoleum", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_walking_mausoleum.png", Flags: []string{"stackable"}},
	0x40002233: {Name: "Note: Unseen Assassins", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_unseen_assassins.png", Flags: []string{"stackable"}},
	0x40002234: {Name: "Note: Great Coffins", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_great_coffins.png", Flags: []string{"stackable"}},
	0x40002235: {Name: "Note: Flame Chariots", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_flame_chariots.png", Flags: []string{"stackable"}},
	0x40002236: {Name: "Note: Demi-human Mobs", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_demi_human_mobs.png", Flags: []string{"stackable"}},
	0x40002237: {Name: "Note: Land Squirts", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_land_squirts.png", Flags: []string{"stackable"}},
	0x40002238: {Name: "Note: Gravity's Advantage", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_gravitys_advantage.png", Flags: []string{"stackable"}},
	0x40002239: {Name: "Note: Revenants", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_revenants.png", Flags: []string{"stackable"}},
	0x4000223A: {Name: "Note: Waypoint Ruins", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_waypoint_ruins.png", Flags: []string{"stackable"}},
	0x4000223B: {Name: "Note: Gateway", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_gateway.png", Flags: []string{"stackable"}},
	0x4000223D: {Name: "Note: Frenzied Flame Village", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_frenzied_flame_village.png", Flags: []string{"stackable"}},

	// ─── Notes (DLC) ────────────────────────────────────────────────────
	0x401EA3D9: {Name: "Furnace Keeper's Note", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/furnace_keepers_note.png", Flags: []string{"dlc", "stackable"}},
	0x401EA443: {Name: "Note: Sealed Spiritsprings", Category: "info", MaxInventory: 99, MaxStorage: 600, MaxUpgrade: 0, IconPath: "items/tools/quest/note_sealed_spiritsprings.png", Flags: []string{"dlc", "stackable"}},
