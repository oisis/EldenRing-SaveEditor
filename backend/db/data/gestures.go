...
var Gestures = map[uint32]ItemData{
	...
	0x401EA7AA: {Name: "The Two Fingers", Category: "gestures", MaxInventory: 1, MaxStorage: 0, MaxUpgrade: 0, IconPath: "items/gestures/the_two_fingers.png", Flags: []string{"dlc"}},
