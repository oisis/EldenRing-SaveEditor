...
// StartingClasses maps Class ID (0-11) to base stats.
...
var StartingClasses = map[uint8]ClassStats{
	...
	// Regulation 1.17 (DLC) starting classes.
	10: {ID: 10, Name: "Idus Knight", Level: 7, Vigor: 10, Mind: 12, Endurance: 11, Strength: 13, Dexterity: 15, Intelligence: 8, Faith: 11, Arcane: 6},
	11: {ID: 11, Name: "Heavy Knight", Level: 10, Vigor: 14, Mind: 8, Endurance: 17, Strength: 15, Dexterity: 11, Intelligence: 7, Faith: 8, Arcane: 9},
}
