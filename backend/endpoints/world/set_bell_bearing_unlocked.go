...
Input variables: characterID, bellBearingResourceID, unlocked, expectedRevision.
...
var SetBellBearingUnlockedDefinition = contract.MustDefine(contract.Definition{
	...
	SupportedResourceVariables: []string{"characterID", "bellBearingResourceID", "unlocked", "expectedRevision"},
