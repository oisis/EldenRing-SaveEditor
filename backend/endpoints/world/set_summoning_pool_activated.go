...
Input variables: characterID, summoningPoolResourceID, activated, expectedRevision.
...
var SetSummoningPoolActivatedDefinition = contract.MustDefine(contract.Definition{
	...
	SupportedResourceVariables: []string{"characterID", "summoningPoolResourceID", "activated", "expectedRevision"},
