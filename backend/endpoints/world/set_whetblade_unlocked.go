...
Input variables: characterID, whetbladeResourceID, unlocked, expectedRevision.
...
var SetWhetbladeUnlockedDefinition = contract.MustDefine(contract.Definition{
	...
	SupportedResourceVariables: []string{"characterID", "whetbladeResourceID", "unlocked", "expectedRevision"},
