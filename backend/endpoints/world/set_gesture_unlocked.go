...
Input variables: characterID, gestureResourceID, unlocked, expectedRevision.
...
var SetGestureUnlockedDefinition = contract.MustDefine(contract.Definition{
	...
	SupportedResourceVariables: []string{"characterID", "gestureResourceID", "unlocked", "expectedRevision"},
