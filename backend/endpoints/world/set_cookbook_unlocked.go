...
Input variables: characterID, cookbookResourceID, unlocked, expectedRevision.
...
var SetCookbookUnlockedDefinition = contract.MustDefine(contract.Definition{
	...
	SupportedResourceVariables: []string{"characterID", "cookbookResourceID", "unlocked", "expectedRevision"},
