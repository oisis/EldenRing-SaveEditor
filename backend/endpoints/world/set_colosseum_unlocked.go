...
Input variables: characterID, colosseumResourceID, unlocked, expectedRevision.
...
var SetColosseumUnlockedDefinition = contract.MustDefine(contract.Definition{
	...
	SupportedResourceVariables: []string{"characterID", "colosseumResourceID", "unlocked", "expectedRevision"},
