...
Input variables: characterID, graceResourceID, visited, expectedRevision.
...
var SetGraceVisitedDefinition = contract.MustDefine(contract.Definition{
	...
	SupportedResourceVariables: []string{"characterID", "graceResourceID", "visited", "expectedRevision"},
