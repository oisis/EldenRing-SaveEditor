...
Input variables: characterID, weaponOwnedItemID, ashOfWarResourceID, expectedRevision.
...
var SetWeaponAshOfWarDefinition = contract.MustDefine(contract.Definition{
	...
	SupportedResourceVariables: []string{"characterID", "weaponOwnedItemID", "ashOfWarResourceID", "expectedRevision"},
