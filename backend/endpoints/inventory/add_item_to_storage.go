...
Input variables: characterID, resourceID, variantID, quantity, expectedRevision.
...
var AddItemToStorageDefinition = contract.MustDefine(contract.Definition{
	...
	SupportedResourceVariables: []string{"characterID", "resourceID", "variantID", "quantity", "expectedRevision"},
