...
Input variables: characterID, destination, resourceID, variantID, quantity.
...
var GetItemCapacityDefinition = contract.MustDefine(contract.Definition{
	...
	SupportedResourceVariables: []string{"characterID", "destination", "resourceID", "variantID", "quantity"},
