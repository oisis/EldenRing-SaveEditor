...
//
// This is the first phase of the Inventory surface. Apart from the owned-item
...
// capacity and no Storage record: those need a verified GaItem parser and belong
// to a later phase.
//
