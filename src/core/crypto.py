...
PC_SAVE_KEY = bytes([
    0x42, 0x03, 0xB2, 0xEF, 0xCC, 0x74, 0x61, 0x37, 
    0x45, 0x63, 0x51, 0x72, 0x67, 0xAD, 0x27, 0x33
])
...
def decrypt_pc_save(data: bytes) -> bytes:
    ...
    cipher = Cipher(algorithms.AES(PC_SAVE_KEY), modes.CBC(iv), backend=default_backend())
