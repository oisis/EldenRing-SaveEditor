...
| Transport status | transport-exposed — `GET /api/v1/catalog/item-variants` of the local OpenAPI explorer (`tools/swagger`). No Wails binding and no permanent CLI command reach it. |
