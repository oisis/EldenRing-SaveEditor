...
SaveForge 1.5.8 and 1.6.8 carry byte-identical implementations of this
...
copy in `tmp/er-sf-1.6.8/internal/application/app_world.go` is identical to the
`v1.6.8` tag. SaveForge 2.0 therefore reproduces the same single-flag semantics,
