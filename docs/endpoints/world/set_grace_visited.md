...
SaveForge 1.5.8 and 1.6.8 carry semantically identical implementations of this
...
two tags, and the local read-only copy in `tmp/er-sf-1.6.8` matches the `v1.6.8`
tag byte for byte.
