...
receipt members and `characterID`, `startingClassID`, `attributes`, `level`,
`soulMemory` all sit at the top level, and there is no nested `receipt` object.
